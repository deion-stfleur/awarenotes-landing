...
function LandingPage() {
  ...
  return (
    ...
    <div className='login-row'>
            ...
            <p className='login' style={{ color: bgColor === "white" ? "#333" : "white" }}>Login</p>
                </Link>
            </div>
          {bgColor === "white" ? (
        ...
        <div>
          ...
          <div className='plt-row'>
            <a target={"_blank"} href="https://apps.apple.com/us/app/awarenotes/id6563151353">
              <img src={logo} alt="Download Awarenotes on App Store" />
            </a>
            <div className='sep'></div>
            <a target={"_blank"} href="https://play.google.com/store/apps/details?id=com.msimeon.awarenotes03">
              <img src={android} alt="Download Awarenotes on Play Store" />
            </a>
          </div>
